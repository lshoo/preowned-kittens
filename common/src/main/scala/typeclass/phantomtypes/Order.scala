package typeclass.phantomtypes
...
object OrderingSystemApp {
  def main(args: Array[String]) {
    val o = Order.emptyOrder
    val o1 = OrderingSystem.addItem("No.1 item", o)
    val o2 = OrderingSystem.addShipping("shenzhen", o1)
    OrderingSystem.placeOrder(o2)
  }
}